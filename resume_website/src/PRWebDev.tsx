...
function WebDev()
{
    return (
        <>
            ...
            <Preset.ProjectPreset1I_1P title='Click Counter' date='12/11/2023' github='https://github.com/SuperFire-92/CIS212_Homework03' special={true} image1='/assets/ClickCounter.png'
