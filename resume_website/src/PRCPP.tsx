...
function CPP()
{
    return (
        <>
            <Preset.SectionHeader title='Visual Studio C++' width='85%'/>
            <br/>
            ...
            maze.</>}
            paragraph2={<>Here is all of the code used to solve the maze. In this, you can find the functions used to read the maze into an array, display the array, and solve the maze.
            To solve the maze, I used recursion to search every possible path from the start to the end. It would prioritize the directions right, down, left, and up in that
            order.</>}
